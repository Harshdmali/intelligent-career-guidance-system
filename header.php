					...
					<ul class="main-menu nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-content">
								<a href="career_prediction.php">Career Prediction</a>
                                <a href="courses.php">Courses</a>
                                <a href="knowledge_network.php">Knowledge Network</a>
                                <a href="aptitude_test.php">Aptitude Test</a>
                                <a href="roadmaps.php">Career Roadmaps</a>
                                <a href="chatbot.php">Career Assistant</a>
                            </div>
                        </li>
